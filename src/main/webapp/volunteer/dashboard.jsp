...
<head>
    ...
    <title>Volunteer Dashboard – Sahayog Sathi</title>
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .avatar { width:72px; height:72px; border-radius:50%; background:#0891B2; color:#fff; font-size:28px; font-weight:700; display:flex; align-items:center; justify-content:center; margin:0 auto 20px; }
        .role-badge { display:inline-block; padding:4px 14px; border-radius:20px; font-size:12px; font-weight:700; text-transform:uppercase; background:#CFFAFE; color:#155E75; margin-bottom:16px; }
...
<div class="card">
    ...
    <p>You're logged in as a <strong>Volunteer</strong> on Sahayog Sathi.</p>
    <div class="coming-soon">
        <strong>Volunteer dashboard coming soon</strong>
        <span>Delivery management features are being built.</span>
    </div>
