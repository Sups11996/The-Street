...
<head>
    ...
    <title>Donor Dashboard – Sahayog Sathi</title>
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .avatar { width:72px; height:72px; border-radius:50%; background:#2563EB; color:#fff; font-size:28px; font-weight:700; display:flex; align-items:center; justify-content:center; margin:0 auto 20px; }
        .role-badge { display:inline-block; padding:4px 14px; border-radius:20px; font-size:12px; font-weight:700; text-transform:uppercase; background:#DBEAFE; color:#1E40AF; margin-bottom:16px; }
...
<div class="card">
    ...
    <div class="role-badge">Donor</div>
    <h1>Welcome, <%= firstName %>!</h1>
    <p>You're logged in as a <strong>Donor</strong> on Sahayog Sathi.</p>
    <div class="coming-soon">
        <strong>Donor dashboard coming soon</strong>
        <span>Donation management features are being built.</span>
    </div>
